...
#******************** VERSION - 4 DF Robot TOF 4 METER DFRobot WALK & GOSEE CODE *********************
    
#******************************** VERSION - 4 DF Robot TOF WALK CODE *******************************
...
#                if 1.524 <= distance_m <= 2.1336: #5 to 7 feet
                if 5 <= distance_ft <= 7:  # 5 to 7 feet
                    ...
                    media.stop()
                    print("ALERT!!!")
                    engine.say(f'obstacle at {distance} feet distance')
                    engine.runAndWait()
...
#******************************** VERSION - 4 DF Robot TOF GOSEE CODE *******************************
